#!/usr/bin/env python3
"""
PRISM v28 — Itération 2 | Suppression SOL (grande perdante)
============================================================
Base : v28 (27 symboles, cooldown 5h, ADX/score leverage)
Delta v28 vs v28 :
  - SOL-USDT retiré (17% WR sur 6 trades, -€120 sur 6 mois en Agressif)
  - 26 symboles actifs

Raisonnement : SOL est le plus grand frein de v28. Avec 6 trades et 17% WR
(1 seul gagnant sur 6), la statistique est significative. Les BB squeezes
SOL échouent systématiquement dans ce régime de marché.
"""
...
SYMBOLS = [
    # v28 : 26 symboles (v28 moins SOL — 6 trades 17% WR -€120)
    "BTC-USDT", "AVAX-USDT",
...
ADX_MIN_C        = 20
TIME_STOP_H      = 72
COOLDOWN_BARS    = 5       # v22: 8 → v28: 5 (plus de signaux)
...
def print_report(trades, eq_curve, cfg_name: str, t0: float):
    ...
    console.print(f"\n[bold cyan]━━━ PRISM v28 | 26 Symboles | Config: {cfg_name} ━━━[/bold cyan]")
    console.print(
    ...
    if trades:
        ...
        stbl = Table(title="PnL par Symbole (v28 — 30 symboles)", box=box.SIMPLE_HEAD)
...
def run_backtest(cfg_name: str = "Agressif") -> dict:
    ...
    console.print(f"\n[bold]PRISM v28 — 26 Symboles | {cfg_name}[/bold]")
    console.print(
        ...
        f"  Symboles: {len(SYMBOLS)} (26 actifs, FIL/ETH/ALGO/SOL retirés)"
    )
...
if __name__ == "__main__":
    console.print(
        "[bold yellow]PRISM v28 — Scale-Out | 26 Symboles | Cooldown 5h[/bold yellow]"
    )
    console.print(
