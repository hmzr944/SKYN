#!/usr/bin/env python3
"""
PRISM v30 — Peaufinage final | Suppression APT + WLD
=====================================================
Base : v30 (26 symboles, two-pass score-priority, margin cap 60%)
Delta v30 vs v30 :
  - APT-USDT retiré (0% WR sur 2 trades, -€89 Optimal / -€153 Agressif)
  - WLD-USDT retiré (0% WR sur 2 trades, -€47 Optimal / -€66 Agressif)
  - 24 symboles actifs

Raisonnement : APT et WLD sont les deux seuls symboles avec 2 trades ET
0% WR dans TOUTES les configs. Statistiquement significatif. Suppression
directe pour récupérer ~€136 Optimal / ~€219 Agressif sur la période.
"""
...
def print_report(trades, eq_curve, cfg_name: str, t0: float):
    ...
    console.print(f"\n[bold cyan]━━━ PRISM v30 | 24 Symboles | Config: {cfg_name} ━━━[/bold cyan]")
    console.print(
    ...
    if trades:
        ...
        stbl = Table(title="PnL par Symbole (v30 — 30 symboles)", box=box.SIMPLE_HEAD)
...
def run_backtest(cfg_name: str = "Agressif") -> dict:
    ...
    console.print(f"\n[bold]PRISM v30 — 24 Symboles | {cfg_name}[/bold]")
    console.print(
...
if __name__ == "__main__":
    console.print(
        "[bold yellow]PRISM v30 — Scale-Out | 24 Symboles | Cooldown 5h[/bold yellow]"
    )
    console.print(
    ...
    if results:
        console.print("\n")
        tbl = Table(
            title="Comparaison configs — 6 mois | 24 Symboles | Cooldown 5h",
            box=box.ROUNDED
        )
