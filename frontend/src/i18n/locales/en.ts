...
const en = {
  ...
  dashboard: {
    greeting: "Hello, {name}.",
    heroTitleF: "Ready for your\nfirst scan?",
    heroTitleM: "Ready for your\nfirst scan?",
    heroTitleN: "Shall we start with\na first scan?",
    heroSubtitle: "Discover the real state of your skin.",
    startAnalysis: "Start the scan",
    lastScan: "LAST SCAN",
    max100: "/ 100",
    skinLabel: "Skin",
    lesionsLabel: "Lesions",
    chartTitle: "TREND OVER 4 SCANS",
    chartEmpty: "The chart appears after your first scan.",
    tipsTitle: "Tips of the day",
    analyzeSkin: "Scan my skin",
    discoverSkinMap: "Discover your skin map (beta)",
