...
const fr = {
  ...
  dashboard: {
    ...
    heroTitleF: "Prête pour votre\npremière analyse ?",
    heroTitleM: "Prêt pour votre\npremière analyse ?",
    heroTitleN: "On commence par\nune première analyse ?",
    heroSubtitle: "Découvrez l'état réel de votre peau.",
    startAnalysis: "Lancer l'analyse",
    lastScan: "DERNIER SCAN",
    max100: "/ 100",
    skinLabel: "Peau",
    lesionsLabel: "Lésions",
    chartTitle: "ÉVOLUTION SUR 4 SCANS",
    chartEmpty: "La courbe apparaîtra dès votre premier bilan.",
    tipsTitle: "Conseils du jour",
    analyzeSkin: "Analyser ma peau",
    discoverSkinMap: "Découvrir votre carte de peau (bêta)",
